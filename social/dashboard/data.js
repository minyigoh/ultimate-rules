...
rules from WFDF Rules of Ultimate 2025–2028 — full breakdown in bio`,
    hashtags: ['#UltimateFrisbee', '#SpiritOfTheGame', '#WFDFRulesofUltimate', '#LearnUltimateFrisbee', '#UltimateFrisbeeTips'],
    notes: [
      'Drafted 2026-08-27 by the daily task. Awaiting script review. Video not yet rendered — nothing renders until the script clears the first gate.',
      'Planned as nine scenes, the standard three-pair shape: cover, then pairs for 12.6 (the absolute duty), 12.6.1 (the named excuse) and 12.6.2 + 12.6.3 (before you leave the ground), a field tip, and the closing card.',
      ...
      'The scene 6 kicker BEFORE YOU LEAVE THE GROUND is the longest this pipeline has drafted and will probably engage fit_kicker(). That is intended: the type shrinks, the wording does not. If it trips the 27px floor, report the SystemExit rather than shortening the label.',
