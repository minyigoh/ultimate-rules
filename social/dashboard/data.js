...
rule numbers from WFDF Rules of Ultimate 2025–2028 — full breakdown in bio`,
    ...
    notes: [
      ...
      'DRY-MEASURED 2026-09-17 on SVG only \u2014 no PNGs. check_layout.py: 9 slides checked, 0 problems, exit 0. make_carousel.py is committed in content/carousel-post-8/ and is the exact file measured. First recap the draft run has been able to measure since 2026-09-08.',
      ...
      'Three of the seven reels have not cleared the script gate (47, 48, 49) and reel-46 is still at the content gate. All seven have post rows dated on or before 09-24, so the block is ready on the rule as written, but approving 47\u201349 in the same sitting as this deck keeps the week moving together.',
      ...
      'slides stays null and typeDetail is absent until the PNGs exist \u2014 build_desk.py check_slides() fails the whole build on a stem with no file, which broke sync.bat on 2026-09-07.',
...
rules from WFDF Rules of Ultimate 2025–2028 (19.1.1, 19.1.2, 19.1.3, 19.1.4, 19.1.5, 19.1.6) — full breakdown in bio`,
    ...
    notes: [
      ...
      'DRY-MEASURED 2026-09-17 on SVG only \u2014 no PNGs, no frames, no cut. check_layout.py: 9 scenes checked, 0 problems, exit 0. Kickers clear at the standard 34px (655.7 / 719.9 / 708.6 of the 900px column); bodies clear at the standard 36px, all three at last baseline 962 against the 1090 limit, 128px clearance each. Neither auto-fit engages. Projected duration 30.0s over 34 states. First draft-run dry-measure since 2026-09-08.',
