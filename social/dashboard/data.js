...
rules from WFDF Rules of Ultimate 2025–2028 — full breakdown in bio`,
    hashtags: ['#UltimateFrisbee', '#SpiritOfTheGame', '#WFDFRulesofUltimate', '#LearnUltimateFrisbee', '#UltimateFrisbeeTips'],
    notes: [
      'Drafted 2026-08-28 by the daily task. Awaiting script review. Video not yet rendered — nothing renders until the script clears the first gate.',
      'Planned as nine scenes, the standard three-pair shape: cover, then pairs for 12.7 + 12.7.1 with 12.4 (they were already there), 12.7 + 12.7.2 (or whoever changed path) and 12.7.3 (the tiebreaker), a field tip, and the closing card.',
      ...
      'Scene 3 is the densest card in the reel, estimated max_y around 1050 of 1310. Run tools/check_layout.py before believing it; if it collides, move 12.4 to scene 5 rather than trimming rule text.',
      'Longest kicker is #2 OR WHOEVER CHANGED PATH at 788px of the 900px column, so fit_kicker() is not engaged.'
    ]
  }
];
