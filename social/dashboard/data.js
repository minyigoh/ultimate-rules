...
rule numbers from WFDF Rules of Ultimate 2025–2028 — full breakdown in bio`,
  ...
  },
  {
    id: 'reel-46',
    date: '2026-09-20',
    title: 'Don\'t touch a pull you can\'t catch',
    type: 'Reel',
    pillar: 'Rules',
    difficulty: 'Beginner',
    lesson: 46,
    ...
    ig: `The most common free turnover in beginner ultimate happens before anybody has thrown a pass.
...
Follow @learn.ultimatefrisbee — one lesson a day.`,
    tiktok: `the most common free turnover in beginner ultimate happens before anyone throws a pass 🥏
...
rules from WFDF Rules of Ultimate 2025–2028 (7.8, 13.1, 13.1.4, 7.10) — full breakdown in bio`,
    ...
    notes: [
      ...
      'Nine scenes, the three-pair shape. TOTAL = 9.',
      'LIGHT AND UNEVEN BODY LOAD — scene 3 is one block of 34 words, scene 5 is two blocks totalling 47 words plus two number lines, scene 7 is one block of 37 words. All lighter than reel-32\'s three-block card and lighter than both of reel-45\'s. fit_body() is not expected to engage. Scene 5 is the only one worth watching.',
      'KICKERS ARE SHORT — longest is 19 characters. Measured in Chrome against reel-41\'s recorded "#1 CONTACT OFF THE DISC" (654.9px of 900px at 34px Arial Bold), the three land near 500px, 510px and 370px. fit_kicker() is not expected to engage anywhere.',
      'PRESERVE THE RULEBOOK\'S OWN QUOTE MARKS. Both 7.8 and 13.1.4 end with (a “dropped pull”). — curly doubles around the term, inside parentheses, before the full stop. LIKELY _payload() CASE: 13.1.4 starts lower-case on "during". That is the rulebook\'s text, not a bug.',
      '7.8 AND 13.1.4 SAY NEARLY THE SAME THING, ON PURPOSE. 7.8 is the Pull chapter\'s statement; 13.1.4 is the Turnovers chapter listing it as a way possession changes hands. Card 2\'s job is that second framing — "this is a real turnover, not bad luck" — not a restatement. If the two cards read as repetition at the script gate, that is the signal to take the seven-scene fallback.',
      'DO NOT OVERSTATE 7.10 — it covers a pull that lands in the playing field and never goes out. A pull that lands and then rolls out is 7.11, which is lesson 47 material and is deliberately not mentioned.',
  ...
  },
  {
    ...
    review: {
      ...
      content: {status: 'in-review', on: '2026-09-19'}
    },
    postedDate: null,
    folder: 'reel-47',
    source: 'content/reel-47/script-and-caption.md',
    sourceLesson: 'content/lessons-3.json (tag: Restarts)',
    video: 'reel47-brick.mp4',
    slides: null,
    scenes: [
...
rules from WFDF Rules of Ultimate 2025–2028 (7.12, 2.5, 7.11) — full breakdown in bio`,
    hashtags: ['#UltimateFrisbee', '#SpiritOfTheGame', '#WFDFRulesofUltimate', '#LearnUltimateFrisbee', '#UltimateFrisbeeTips'],
    notes: [
      'Dry-measured 2026-09-14 on SVG only, then rendered 2026-09-19 with real ImageMagick and real Liberation Sans via render_v3.py \u2192 blend.py \u2192 encode.py. check_layout.py: 9 scenes checked, 0 problems, exit 0, matching every dry-measured number exactly. Cut runs 29.50s via encode.py exact CFR; check_dull.py longest sustained run 0.17s, PASS (threshold 0.45s). Built from approved scriptRev 1.',
  ...
  },
  {
    ...
    duration: '~30s script / 29.5s cut',
    typeDetail: '1080×1920 · 29.5s · 30fps',
    rules: ['20.3', '20.2', '20.1', '20.3.6'],
    review: {
      script:  {status: 'pending', on: '2026-09-15'},
      content: {status: 'in-review', on: '2026-09-19'}
    },
    postedDate: null,
    folder: 'reel-48',
    source: 'content/reel-48/script-and-caption.md',
    sourceLesson: 'content/lessons-3.json (tag: Game)',
    video: 'reel48-time-out.mp4',
    slides: null,
    scenes: [
    ...
    ig: `Who can call a time-out, and what happens to everybody's feet.
...
Follow @learn.ultimatefrisbee — one lesson a day.`,
    tiktok: `who can call a time-out, and what happens to everybody's feet 🥏
...
rules from WFDF Rules of Ultimate 2025–2028 (20.3, 20.2, 20.1, 20.3.6) — full breakdown in bio`,
    hashtags: ['#UltimateFrisbee', '#SpiritOfTheGame', '#WFDFRulesofUltimate', '#LearnUltimateFrisbee', '#UltimateFrisbeeTips'],
    notes: [
      'Nine scenes: cover, three topic/rules-detail pairs, field tip, closing. Three rule cards (20.3, 20.1, 20.3.6).',
      'DRY-MEASURED 2026-09-15 on SVG only \u2014 no PNGs, no frames, no cut. check_layout.py: 9 scenes checked, 0 problems, exit 0. Kickers clear at the standard 34px (478.0 / 602.8 / 791.7 of the 900px column); bodies clear at the standard 36px (last baselines 962 / 1040 / 1040 against the 1090 limit). Neither auto-fit engages. Projected duration 30.0s over 34 states.',
      'Rendered 2026-09-19 with real ImageMagick and real Liberation Sans via render_v3.py \u2192 blend.py \u2192 encode.py. check_layout.py: 9 scenes, 0 problems, matching every dry-measured number exactly. Cut runs 29.50s via encode.py exact CFR; check_dull.py longest sustained run 0.17s, PASS (threshold 0.45s). Built from approved scriptRev 1.',
      'v1 of this copy relied on auto-fit in three places \u2014 scene 2\'s body landed on 1090, the limit exactly; scenes 4 and 6 shrank to 34px and 32px; the #1 kicker shrank to 29px against its 27px floor. The copy was shortened at the draft gate, which is the only place shortening is allowed. Once approved, the rule is shrink the type, never reword.',
      '20.2 is quoted in both captions but is not carded \u2014 it covers the before-the-pull window, a different situation from the live-point rule the reel is about, and a fourth pair would have pushed the cut past the 33s band. Every card footer cites only the rule its own card quotes.',
      '20.3.2 and 20.3.3 (restart at the pivot location; the thrower must remain the same) are stated as prose in the captions and the example beat but carry no rule number anywhere, because neither is in this lesson\'s rules array.',
      '"Maximum nine" is not "back to nine". 20.3.6 caps the restart at nine, it does not raise a lower count up to nine \u2014 a time-out at stalling four restarts at four. The copy says "picks up where it left off, capped at nine" throughout. Do not simplify that to "restarts at nine" at review; it is the obvious edit and it is wrong.',
      'Preserve the rulebook\'s punctuation: 20.3 ends on a colon because its sub-rules continue it, and 20.1 and 20.3.6 carry curly doubles and parenthesised numerals. All of it is correct and must survive to the PNG and the caption unchanged.',
      'First chapter-20 material on the account \u2014 scenes 3, 5 and 7 render the citation label RULE 20.3 \u00b7 TIME-OUTS from rules.json. No new layout, but a label nobody has seen before.',
      'Lesson 39 ("What the stall count restarts at") is the general case; 20.3.6 is the time-out case. They do not overlap on the card and no cross-reference is needed on screen.',
      'Instagram caption 1,994 characters including hashtags (90.6% of the 2,200 limit, under the 2,090 warn line); TikTok 1,642 of 4,000. Four verbatim quotations totalling 692 characters \u2014 chapter 20\'s rules are short, which is why a fourth quotation fits here and would not have fitted on reel-47.',
      'Curriculum position: lesson 48 is index 14 of content/lessons-3.json, the next unused lesson after 47. It covers 2026-09-22, the only bare date in the tomorrow-through-tomorrow+6 window this run.'
    ]
  },
  {
    id: 'reel-49',
    date: '2026-09-23',
    title: "Calling a time-out you don't have",
    type: 'Reel',
    pillar: 'Rules',
    difficulty: 'Beginner',
    lesson: 49,
    ...
    rules: ['20.4'],
    review: {
      script:  {status: 'pending', on: '2026-09-16'},
      content: {status: 'in-review', on: '2026-09-19'}
    },
    postedDate: null,
    folder: 'reel-49',
    source: 'content/reel-49/script-and-caption.md',
    sourceLesson: 'content/lessons-3.json (tag: Game)',
    video: 'reel49-no-timeouts-left.mp4',
    slides: null,
    scenes: [
    ...
    ig: `A small, precise penalty worth knowing before you need it.
...
Follow @learn.ultimatefrisbee — one lesson a day.`,
    tiktok: `calling a time-out you don't have 🥏
...
rules from WFDF Rules of Ultimate 2025–2028 (20.4) — full breakdown in bio`,
    hashtags: ['#UltimateFrisbee', '#SpiritOfTheGame', '#WFDFRulesofUltimate', '#LearnUltimateFrisbee', '#UltimateFrisbeeTips'],
    notes: [
      'Seven scenes, not nine: one rule card (20.4), so one topic/rules-detail pair plus two unpaired topic scenes. Single-rule shape, same as reels 11 and 17. TOTAL = 7.',
      'DRY-MEASURED 2026-09-16 on SVG only \u2014 no PNGs, no frames, no cut. check_layout.py: 7 scenes checked, 0 problems, exit 0. Kickers clear at the standard 34px (593.3 / 808.7 / 561.2 of the 900px column); bodies clear at the standard 36px (last baselines 962 / 962 / 962 against the 1090 limit, 128px clearance each). Neither auto-fit engages. Projected duration 28.7s over 30 states.',
      'Rendered 2026-09-19 with real ImageMagick and real Liberation Sans via render_v3.py \u2192 blend.py \u2192 encode.py. check_layout.py: 7 scenes, 0 problems, matching every dry-measured number exactly. Cut runs 28.33s via encode.py exact CFR, the same duration as reels 11 and 17\u2019s single-rule shape; check_dull.py longest sustained run 0.17s, PASS (threshold 0.45s). Built from approved scriptRev 1.',
      'v1 of this copy put all three main bodies on 1090 \u2014 the limit exactly, zero clearance, one character from SystemExit on each of the three. Each headline was cut from three wrapped lines to two and each body from five to four, at the draft gate, which is the only place shortening is allowed. Once approved, the rule is shrink the type, never reword.',
      'The two seconds land on the RESTART count, not on the count at the moment you called. 20.4 says "the stall count they would have restarted play on" \u2014 a count that would have restarted on six restarts on eight, one that would have restarted on eight restarts on ten, which is a stall-out. Do not compress this to "adds two to the stall count" anywhere; it changes the arithmetic.',
      "20.3 and 20.3.6 (the seventy-five-second time-out, the maximum-nine restart) belong to reel 48 and are not in this lesson's rules array, so they carry no rule number or citation footer here.",
      'Preserve the rulebook\u2019s punctuation: 20.4 carries curly doubles around "stall-out" and parenthesised numerals \u2014 "two (2) seconds", "ten (10) or above". All of it must survive to the PNG and the caption unchanged.',
      'Reel 48 is the prerequisite and posts 2026-09-22, the day before this one. Nothing on screen cross-references it, but the ordering is deliberate and should not be swapped at the desk.',
      'Instagram caption 1,869 characters including hashtags (85.0% of the 2,200 limit, under the 2,090 warn line); TikTok 1,525 of 4,000. Both plain text, both scanned clean of markdown, both measured in UTF-16 units by tools/check_caption.py, which exits 0.',
      'Curriculum position: lesson 49 is index 15 of content/lessons-3.json, the next unused lesson after 48. It covers 2026-09-23, the only bare date in the tomorrow-through-tomorrow+6 window this run.',
      'No growth/reach claims in either caption.'
    ]
  },
  {
    id: 'carousel-post-8',
    date: '2026-09-24',
    title: 'carousel-post-8 \u2014 "Week seven: the time between plays"',
    type: 'Carousel',
    pillar: 'Recap',
    difficulty: 'Mixed (beginner)',
    lesson: null,
    duration: '9 slides',
    typeDetail: '2250×2812 · 9 slides',
    rules: ['13.11', '13.11.1', '13.11.2', '13.11.2.1', '13.11.3', '8.5', '8.5.1.1', '8.5.1.2', '8.5.2', '8.5.2.1', '8.5.3', '8.1', '8.1.1', '8.1.2', '8.1.3', '8.1.4', '8.2', '8.3', '7.8', '13.1.4', '7.10', '7.12', '2.5', '7.11', '20.1', '20.2', '20.3', '20.3.1', '20.3.4', '20.3.5', '20.3.6', '20.4'],
    review: {
      script:  {status: 'pending', on: '2026-09-17'},
      content: {status: 'in-review', on: '2026-09-19'}
    },
    postedDate: null,
    folder: 'carousel-post-8',
    source: 'content/carousel-post-8/script-and-caption.md',
    sourceLesson: 'content/lessons-3.json (lessons 43-49)',
    video: null,
    slides: [
      ['01_cover', 'Cover — THIS WEEK'],
      ['02_lesson43_own_end_zone', 'Lesson 43 — Turnover in your own end zone: you choose'],
      ['03_lesson44_fetch_promptly', 'Lesson 44 — "You have to fetch the disc promptly"'],
      ['04_lesson45_live_and_dead', 'Lesson 45 — Live play and dead play'],
      ['05_lesson46_dropped_pull', 'Lesson 46 — "Don\'t touch a pull you can\'t catch"'],
      ['06_lesson47_the_brick', 'Lesson 47 — Pulls that go out of bounds: the brick'],
      ['07_lesson48_time_out', 'Lesson 48 — Calling a time-out'],
      ['08_lesson49_no_time_outs_left', 'Lesson 49 — Calling a time-out you don\'t have'],
      ['09_closing', 'Closing — "That\'s forty-nine of seventy-five."']
    ],
    scenes: [
      ...
      ['2', 'LESSON 43', '"Turnover in your own end zone: you choose" \u00b7 footer 13.11 \u00b7 13.11.1 \u00b7 13.11.2 \u00b7 13.11.2.1 \u00b7 13.11.3'],
      ['3', 'LESSON 44', '"You have to fetch the disc promptly" \u00b7 footer 8.5 \u00b7 8.5.1.1 \u00b7 8.5.1.2 \u00b7 8.5.2 \u00b7 8.5.2.1 \u00b7 8.5.3'],
      ['4', 'LESSON 45', '"Live play and dead play" \u00b7 footer 8.1 \u00b7 8.1.1 \u00b7 8.1.2 \u00b7 8.1.3 \u00b7 8.1.4 \u00b7 8.2 \u00b7 8.3'],
      ['5', 'LESSON 46', '"Don\'t touch a pull you can\'t catch" \u00b7 footer 7.8 \u00b7 13.1.4 \u00b7 7.10'],
      ['6', 'LESSON 47', '"Pulls that go out of bounds: the brick" \u00b7 footer 7.12 \u00b7 2.5 \u00b7 7.11'],
      ['7', 'LESSON 48', '"Calling a time-out" \u00b7 footer 20.1 \u00b7 20.2 \u00b7 20.3 \u00b7 20.3.1 \u00b7 20.3.4 \u00b7 20.3.5 \u00b7 20.3.6'],
      ['8', 'LESSON 49', '"Calling a time-out you don\'t have" \u00b7 footer 20.4'],
    ...
    ig: `Week seven, all in one place. Seven lessons about the time between plays — the seconds when the disc is on the ground, in the air off a pull, or waiting on a call.
...
rule numbers from WFDF Rules of Ultimate 2025–2028 — full breakdown in bio`,
    hashtags: ['#UltimateFrisbee', '#SpiritOfTheGame', '#WFDFRulesofUltimate', '#LearnUltimateFrisbee', '#UltimateFrisbeeTips'],
    notes: [
      'Weekly recap, block 43\u201349 \u2014 a clean contiguous seven, opening where carousel-post-7 stopped. Consumes no lesson number. Rule numbers only, no rule text. carousel-post-9 opens at lesson 50.',
      'Lesson 28 ("Receiving fouls") remains permanently skipped per Min-Yi\u2019s decision on 2026-09-12. Not on this deck, and not to be reintroduced on any later one.',
      'Rendered 2026-09-19 with real ImageMagick and real Liberation Sans, from the same make_carousel.py dry-measured on 2026-09-17. check_layout.py: 9 slides checked, 0 problems, exit 0. PNGs at 2250\u00d72812, pixel-identical layout system to the back catalogue.',
      'The cover overran on the first pass: "Week seven: the time" measured 974.6 of the 900px column at 96px, 74.6px of x-overflow \u2014 the first cover overrun the account has had. Fixed by rebreaking the line, not by changing the title or the type: "Week seven: the" / "time between plays" measures 750.6px and 880.3px. Line two has 19.7px spare. Re-measure the cover if the title is edited at the desk.',
      'fit_body() does not engage on any slide. Every takeaway wraps to three lines at the standard 36px; last baselines 912 (slides 2, 3, 5, 6, 8) and 834 (slides 4, 7) against the 1090 limit.',
      'Slide 7 carries the widest citation line ever attempted on a recap: seven numbers, 66 characters, 665.9 of the 900px column. It is the lesson\u2019s rules array unchanged, which is how every recap footer has worked.',
      'Takeaways are each lesson\u2019s field line from content/lessons-3.json, verbatim. No rule text appears on any slide.',
      'Title checked against the last slide, not just the theme of the first five \u2014 the carousel-post-6 v1 check. Slides 7 and 8 are time-outs, which are purchased gaps between plays, so "the time between plays" covers all seven. "Restarts and stoppages" was dropped as too close to carousel-post-7.',
      'All seven reels (43\u201349) now have approved scripts; reels 43\u201346 also have approved content. All seven have post rows dated on or before 09-24, so the block is ready on the rule as written.',
      'tracked() in the carousel path still uses a plain space, not the U+00A0 the reel path switched to on reel-38. Verified on the shipped carousel-post-7 PNGs rather than assumed: the word gap in LESSON 36 measures 29.3px against 10.6px letter gaps, so ImageMagick is not collapsing the run and decks 1-7 are correct as rendered. Headless Chrome would collapse it, so a recap built through tools/WINDOWS_FALLBACK.md would lose the gap in "LESSON NN" and "THIS WEEK". Left as-is to stay identical to the back catalogue; flagged for a deliberate decision.',
      'The closing count is exact on the day: lesson 49 posts 2026-09-23, the day before this deck.',
      'Instagram caption 1,900 characters including hashtags (86.4% of the 2,200 limit, under the 2,090 warn line); TikTok 1,252 of 4,000. Both plain text, both scanned clean of markdown, both measured in UTF-16 units by tools/check_caption.py, which exits 0.',
      'No growth/reach claims in either caption.'
    ]
  },
  {
    ...
    duration: '~30s script / 29.5s cut',
    typeDetail: '1080×1920 · 29.5s · 30fps',
    rules: ['19.1.1', '19.1.2', '19.1.3', '19.1.4', '19.1.5', '19.1.6'],
    review: {
      script:  {status: 'pending', on: '2026-09-17'},
      content: {status: 'in-review', on: '2026-09-19'}
    },
    postedDate: null,
    folder: 'reel-50',
    source: 'content/reel-50/script-and-caption.md',
    sourceLesson: 'content/lessons-3.json (tag: Safety)',
    video: 'reel50-injury-stoppages.mp4',
    slides: null,
    scenes: [
    ...
    ig: `What happens when someone goes down, and what it costs your team.
...
rules from WFDF Rules of Ultimate 2025–2028 (19.1.1, 19.1.2, 19.1.3, 19.1.4, 19.1.5, 19.1.6) — full breakdown in bio`,
    hashtags: ['#UltimateFrisbee', '#SpiritOfTheGame', '#WFDFRulesofUltimate', '#LearnUltimateFrisbee', '#UltimateFrisbeeTips'],
    notes: [
      'Nine scenes, three topic/rules-detail pairs. TOTAL = 9. All six rules in the lesson\u2019s array are carded, two per card; every card footer cites only the rules its own card quotes.',
      'Dry-measured 2026-09-17 on SVG only, then rendered 2026-09-19 with real ImageMagick and real Liberation Sans via render_v3.py \u2192 blend.py \u2192 encode.py. check_layout.py: 9 scenes checked, 0 problems, exit 0. Kickers clear at the standard 34px (655.7 / 719.9 / 708.6 of the 900px column); bodies clear at the standard 36px, all three at last baseline 962 against the 1090 limit, 128px clearance each. Neither auto-fit engages. Cut runs 29.50s via encode.py exact CFR; check_dull.py longest sustained run 0.20s, PASS.',
      'v1 of this copy put the scene 4 and scene 6 bodies on 1090 \u2014 the limit exactly, zero clearance, one character from SystemExit. Both headlines were cut from three wrapped lines to two and both bodies from five lines to four, at the draft gate, which is the only place shortening is allowed. Once approved, the rule is shrink the type, never reword.',
      'render_v3.py is committed in content/reel-50/ and is the exact file these numbers were measured from \u2014 adapted from reel-46, so it carries the tracked() non-breaking-space word-gap fix. Copy blend.py and encode.py in from reel-46; they are generic.',
      '"The injured player\u2019s team" is load-bearing: 19.1.1 gives the call to the injured player or their own team-mates, and the opposition cannot call it for you. Do not soften it to "anyone".',
      'The stoppage rewinds to the moment of the injury, not the moment of the call (19.1.5). That is what makes a slightly late call harmless.',
      'The substitute-or-time-out fork only applies when no opponent caused the injury. 19.1.2 and 19.1.3 are two halves of one decision and are carded together; reading 19.1.2 alone makes every injury sound costly, which is the obvious misreading.',
      'Do not reach for chapter 12. How a substitution is actually made is lesson 52; 19.1.2 names it and this reel does not explain it.',
      'Preserve the rulebook\u2019s punctuation: 19.1.1 carries curly doubles around "Injury" and a curly apostrophe in "player\u2019s". The caption text was generated from rules.json rather than retyped, for exactly this reason.',
      'Instagram caption 1,754 characters including hashtags (79.7% of the 2,200 limit, well under the 2,090 warn line); TikTok 1,411 of 4,000. Both plain text, both scanned clean of markdown, both measured in UTF-16 units by tools/check_caption.py, which exits 0.',
      'Three rules are quoted in full in the captions (19.1.1, 19.1.2, 19.1.4); 19.1.3, 19.1.5 and 19.1.6 are carded on screen and paraphrased in the caption prose, with all six numbers in the attribution line.',
      'Curriculum position: lesson 50 is index 16 of content/lessons-3.json, the next unused lesson after 49. It covers 2026-09-24, the only bare reel date in the tomorrow-through-tomorrow+6 window this run.',
      'No growth/reach claims in either caption.'
    ]
  },
  {
    id: 'reel-51',
    date: '2026-09-25',
    title: 'Technical stoppages and blood',
    type: 'Reel',
    pillar: 'Rules',
    difficulty: 'Beginner',
    lesson: 51,
    ...
    ig: `Anyone can stop the game for a safety issue. Anyone.
...
rules from WFDF Rules of Ultimate 2025–2028 (19.2.1, 19.2.1.1, 19.2.1.2, 19.2.2) — full breakdown in bio`,
    hashtags: ['#UltimateFrisbee', '#SpiritOfTheGame', '#WFDFRulesofUltimate', '#LearnUltimateFrisbee', '#UltimateFrisbeeTips'],
    notes: [
      'Nine scenes, three topic/rules-detail pairs. TOTAL = 9. Four of the lesson\u2019s five rules are carded; every card footer cites only the rules its own card quotes.',
      'DECISION NEEDED AT THE SCRIPT GATE: 19.2.3 is in the lesson\u2019s rules array but is not carded, quoted or cited. Its text in rules.json ends in a colon and is a complete sentence only with 19.2.3.1 and 19.2.3.2, which are not in the array. Either add those two numbers to technical-stoppage.rules in content/lessons-3.json and this reel grows a fourth card, or drop 19.2.3 from the array so it stops reading as an omission. Request changes with whichever you want. Both sub-rules exist verbatim in rules.json; nothing would be invented either way.',
      'DRY-MEASURED 2026-09-18 on SVG only \u2014 no PNGs, no frames, no cut. check_layout.py: 9 scenes checked, 0 problems, exit 0. Kickers clear at the standard 34px (595.2 / 585.7 / 708.5 of the 900px column); bodies clear at the standard 36px \u2014 scenes 2 and 6 at last baseline 962 (128px clearance), scene 4 at 912 (178px) against the 1090 limit. Neither auto-fit engages. Projected duration 30.0s over 34 states.',
      'render_v3.py is committed in content/reel-51/ and is the exact file these numbers were measured from \u2014 copied from reel-50, so it carries the tracked() non-breaking-space word-gap fix; only SCENES differs. Copy blend.py and encode.py in from reel-46; they are generic.',
      '"Any player" is load-bearing and is the opposite of reel 50. 19.2.1 gives this call to anyone who recognises the condition, where the injury stoppage in 19.1.1 belongs to the injured player\u2019s own team. Do not harmonise the two at review \u2014 the difference is why both reels exist.',
      'Seventy seconds is a quoted number, not a rounded one: 19.2.1.2 writes it "seventy (70)" and the card quotes it verbatim with both forms intact.',
      'Scene 4 leans on reel 50 rather than re-teaching it. "Costs what an injury costs" refers to the 19.1.2 fork, which reel 50 cards and which posts 2026-09-24, the day before this one.',
      'Do not add chapter 12. 19.2.1.2 names substitution as one of the two ways to buy more time; how a substitution is made is lesson 52 and gets its own reel.',
      'Preserve the rulebook\u2019s punctuation: 19.2.1 carries curly doubles around "technical" and "stop". The caption text was generated from rules.json rather than retyped, for exactly this reason.',
      'Instagram caption 1,955 characters including hashtags (88.9% of the 2,200 limit, under the 2,090 warn line); TikTok 1,737 of 4,000. Both plain text, both scanned clean of markdown, both measured in UTF-16 units by tools/check_caption.py, which exits 0.',
      'All four carded rules are quoted in full in both captions, and all four numbers are in the attribution line. At 1,955 there was room; a fifth quote would not have fit.',
      'Curriculum position: lesson 51 is index 17 of content/lessons-3.json, the next unused lesson after 50. It covers 2026-09-25, the only bare date in the tomorrow-through-tomorrow+6 window this run.',
      'No growth/reach claims in either caption.'
    ]
  },
  {
    ...
    duration: '~30s script / 29.5s cut',
    typeDetail: '1080×1920 · 29.5s · 30fps',
    rules: ['5.3', '19.3', '19.3.1'],
    review: {
      script:  {status: 'pending', on: '2026-09-21'},
      content: {status: 'in-review', on: '2026-09-22'}
    },
    postedDate: null,
    folder: 'reel-52',
    source: 'content/reel-52/script-and-caption.md',
    sourceLesson: 'content/lessons-3.json (tag: Game)',
    video: 'reel52-substitutions.mp4',
    slides: null,
    scenes: [
    ...
    ig: `Substitutions are unlimited. The window for them is not.
...
rules from WFDF Rules of Ultimate 2025–2028 (5.3, 19.3, 19.3.1) — full breakdown in bio`,
    hashtags: ['#UltimateFrisbee', '#SpiritOfTheGame', '#WFDFRulesofUltimate', '#LearnUltimateFrisbee', '#UltimateFrisbeeTips'],
    notes: [
      "Script rev 2 (2026-09-21), redrafted against a Content Desk 'changes' note: \u201c'Try it during a point and you are playing a player short.' sounds a bit misle[ading]\u201d. The note is right \u2014 the old hook attached the consequence of signalling ready early (playing a player short) to a different cause (substituting mid-point), which 5.3 does not permit in the first place. The hook now states the window closing rather than a punishment, and both captions name the cut-off. Nothing else moved: no rule number, no slide body, no scene, so the layout is byte-identical to v1's and was re-measured to confirm it (check_layout.py exit 0, 9 scenes, 0 problems, identical numbers). Round recorded in content/reel-52/script-feedback.md; v1 archived as script-and-caption.v1.md.",
      'Nine scenes, three topic/rules-detail pairs. TOTAL = 9. All three of the lesson\u2019s rules are carded and quoted in full in both captions; all three numbers are in the attribution line. No omission to decide on, unlike reel 51.',
      'DRY-MEASURED 2026-09-19 on SVG only \u2014 no PNGs, no frames, no cut. check_layout.py: 9 scenes checked, 0 problems, exit 0. Kickers clear at the standard 34px (714.2 / 564.9 / 797.4 of the 900px column); bodies clear at the standard 36px \u2014 scene 2 at last baseline 912 (178px clearance), scenes 4 and 6 at 962 (128px) against the 1090 limit. Neither auto-fit engages. Projected duration 30.0s over 34 states.',
      'render_v3.py is committed in content/reel-52/ and is the exact file these numbers were measured from \u2014 copied from reel-51, so it carries the tracked() non-breaking-space word-gap fix; only SCENES differs. Copy blend.py and encode.py in from reel-46; they are generic.',
      '5.3 is a chapter 5 rule on a chapter 19 week, deliberately. The answer to "when can I sub?" is split across the two chapters; without 5.3 the reel only says when you cannot substitute.',
      '"One for one" is load-bearing on card 2. 19.3 gives the opposition one player, not a matching reshuffle, and the body says so because the rule\u2019s own wording is easy to skim past.',
      'Quote 19.3.1\u2019s brackets as written: "(location, possession, stall count etc)", no full stop after etc. The card and both captions carry it unchanged.',
      'Scene 4 does not re-teach reels 50 and 51. It names injury and faulty equipment as the doorway to a mid-point change and stops there; both of those reels post before this one (2026-09-24 and 2026-09-25).',
      'The field tip says "a player short", not "with six". The lesson\u2019s field line says six, but the minimum on the field is five (5.1) and that rule is not in this lesson\u2019s array, so the copy makes the point without asserting a number it does not card.',
      'Instagram caption 1,692 characters including hashtags at rev 2 (76.9% of the 2,200 limit, well under the 2,090 warn line; was 1,662 at rev 1); TikTok 1,562 of 4,000. Both plain text, both scanned clean of markdown, both measured in UTF-16 units by tools/check_caption.py, which exits 0.',
  ...
  },
  {
    ...
    sourceLesson: 'content/lessons-3.json (tag: Game)',
    video: 'reel53-the-shape-of-a-game.mp4',
    slides: null,
    scenes: [
...
rules from WFDF Rules of Ultimate 2025–2028 (4.2, 4.3, 6.3, 5.1) — full breakdown in bio`,
    hashtags: ['#UltimateFrisbee', '#SpiritOfTheGame', '#WFDFRulesofUltimate', '#LearnUltimateFrisbee', '#UltimateFrisbeeTips'],
    notes: [
      "Script rev 2 (2026-09-21), redrafted against a Content Desk 'changes' note: \u201cMost tournaments will specify the time limit even though it is not mentioned in the game. It is either the 8/15 goals or time whichever comes first right?\u201d. The field tip and both captions now lead with the cap and say it belongs to the event rather than to WFDF. The 'whichever comes first' mechanic is deliberately NOT asserted: there is no time-cap rule anywhere in rules.json, and that phrasing describes a hard cap while many events use a soft cap instead \u2014 so the copy points at the format sheet rather than stating one event's format as the game's. Re-measured after the tip body grew: scene 8 ink bottom 1012 \u2192 1112 against the 1310 floor, 198px clear, fit_body() still not engaging; every other number unchanged, check_layout.py exit 0, 9 scenes, 0 problems. Round recorded in content/reel-53/script-feedback.md; v1 archived as script-and-caption.v1.md.",
      ...
      'Instagram caption 1,664 characters including hashtags at rev 2 (75.6% of the 2,200 limit, well under the 2,090 warn line; was 1,598 at rev 1); TikTok 1,422 of 4,000. Both plain text, both scanned clean of markdown, both measured in UTF-16 units by tools/check_caption.py, which exits 0.',
  ...
  },
  {
    id: 'reel-54',
    date: '2026-09-28',
    title: 'After every goal, you switch ends',
    type: 'Reel',
    pillar: 'Rules',
    difficulty: 'Beginner',
    lesson: 54,
    ...
    ig: `Score a goal and the game does not stop. It turns around.
...
Follow @learn.ultimatefrisbee — one lesson a day.`,
    tiktok: `after every goal, you switch ends 🥏
...
rules from WFDF Rules of Ultimate 2025–2028 (4.5, 4.5.1, 4.5.2, 4.5.3) — full breakdown in bio`,
    hashtags: ['#UltimateFrisbee', '#SpiritOfTheGame', '#WFDFRulesofUltimate', '#LearnUltimateFrisbee', '#UltimateFrisbeeTips'],
    notes: [
      "Nine scenes, three topic/rules-detail pairs. TOTAL = 9. All four of the lesson\u2019s rules are carded and quoted in full in both captions; all four numbers are in the attribution line, in the array\u2019s own order. Scene 3 carries one block \u2014 4.5 with 4.5.1 beneath it; scenes 5 and 7 carry 4.5.2 and 4.5.3.",
      "DRY-MEASURED 2026-09-21 on SVG only \u2014 no PNGs, no frames, no cut. check_layout.py: 9 scenes checked, 0 problems, exit 0. Kickers clear at the standard 34px (850.2 / 619.8 / 704.8 of the 900px column, widest 94.5%, inside reel-11\u2019s 873px high-water mark); bodies clear at the standard 36px, all three main scenes wrapping to four lines with last baseline 962 and 128px clearance against the 1090 limit. Neither auto-fit engages. Rules cards 572 / 404 / 404, tip 1012, cover 1210, mains 1192 against the 1310 floor. Projected duration 30.0s over 34 states.",
      "Scene 2\u2019s body was drafted a sentence longer, wrapped to five lines and measured last baseline 1012 \u2014 passing, at 78px clearance, with fit_body() not engaging. It was tightened to four lines while drafting, before anything reached the desk. The ban is on rewording an approved body to fit; nothing here is approved yet.",
      "4.5 is a colon lead-in governing three numbered items, and is carded as one rather than flattened. Card 1 carries 4.5 plus 4.5.1 so the governing condition (\u201cand the game has not been won or half time has not been reached\u201d) is stated once; cards 2 and 3 carry 4.5.2 and 4.5.3 alone. Same parent-plus-sub shape as reel-51 scene 3.",
      "4.5.2 is quoted with its trailing \u201c; and\u201d intact and 4.5.1 with its semicolon. They are list items, not sentences \u2014 trimming the conjunction would be an edit to rule text. Verbatim means verbatim, punctuation included.",
      "This reel does not teach substitutions. The gap after a goal is also the substitution window, but 5.3 belongs to lesson 52 and is not in this lesson\u2019s rules array, so it is not cited here.",
      "render_v3.py is committed in content/reel-54/ and is the exact file these numbers were measured from \u2014 copied from reel-53, so it carries the tracked() non-breaking-space word-gap fix and the _payload quote fix; only SCENES differs, verified by diffing the two files with their SCENES blocks removed. Copy blend.py and encode.py in from reel-46; they are generic.",
      "Instagram caption 1,373 characters including hashtags (62.4% of the 2,200 limit, well under the 2,090 warn line); TikTok 1,249 of 4,000. Both plain text, both scanned clean of markdown, both measured in UTF-16 units by tools/check_caption.py, which exits 0.",
      "Curriculum position: lesson 54 is index 20 of content/lessons-3.json, the next unused lesson after 53. It covers 2026-09-28, the only bare date in the tomorrow-through-tomorrow+6 window this run. No growth/reach claims in either caption."
    ]
  },
  {
    id: 'reel-55',
    date: '2026-09-29',
    title: 'Offside and false start on the pull',
    type: 'Reel',
    pillar: 'Rules',
    difficulty: 'Beginner',
    lesson: 55,
    ...
    ig: `Two calls live on the pull, and they do not end the same way.
...
Follow @learn.ultimatefrisbee — one lesson a day.`,
    tiktok: `offside and false start on the pull 🥏
...
rules from WFDF Rules of Ultimate 2025–2028 (7.3, 7.4, 7.5, 7.5.1, 7.5.2) — full breakdown in bio`,
    hashtags: ['#UltimateFrisbee', '#SpiritOfTheGame', '#WFDFRulesofUltimate', '#LearnUltimateFrisbee', '#UltimateFrisbeeTips'],
    notes: [
      "Nine scenes, three topic/rules-detail pairs. TOTAL = 9. All five of the lesson\u2019s rules are carded and quoted in full in both captions; all five numbers are in the attribution line, in the array\u2019s own order. Scene 3 carries 7.3 and 7.4 as one block each; scene 5 carries 7.5; scene 7 carries 7.5.1 and 7.5.2.",
      "DRY-MEASURED 2026-09-22 on SVG only \u2014 no PNGs, no frames, no cut. check_layout.py: 9 scenes checked, 0 problems, exit 0. Kickers clear at the standard 34px (823.8 / 772.8 / 767.1 of the 900px column, widest 91.5%, inside reel-11\u2019s 873px high-water mark); bodies clear at the standard 36px, all three main scenes wrapping to four lines with last baseline 962 and 128px clearance against the 1090 limit. Neither auto-fit engages. Rules cards 890 / 554 / 990, tip 1062, cover 1210, mains 1192 against the 1310 floor. Projected duration 30.0s over 36 states.",
      "Scenes 2 and 6 were each drafted longer, wrapped to five lines and measured last baseline 1012 \u2014 passing, at 78px clearance, with fit_body() not engaging. Both were tightened to four lines while drafting, before anything reached the desk. The ban is on rewording an approved body to fit; nothing here is approved yet.",
      "Two cards carry two rule blocks each, deliberately. 7.3/7.4 and 7.5.1/7.5.2 are matched pairs whose teaching value is the contrast between them, and a difference cannot be shown one slide at a time. Seventeen earlier reels ship two-block cards, reel-53 scene 3 most recently. Scene 7 is the tallest rules card in this reel at 990 of the 1310 floor.",
      "7.5\u2019s verbatim text carries \u201c(7.8 still applies)\u201d and the numbers 7.3 and 7.4; 7.5.1\u2019s carries 7.9 through 7.12. Those sit inside the quotation and stay exactly as the rulebook has them. None is cited as a rule of this post, none appears in the attribution line, and no card quotes their text \u2014 the lesson\u2019s rules array is the five above and nothing else.",
      "The field tip is the one place this post gives an instruction rather than a rule, and it follows directly from 7.5.2: the restart only exists if the disc hits the ground untouched, so catching the pull forfeits the call.",
      "render_v3.py is committed in content/reel-55/ and is the exact file these numbers were measured from \u2014 copied from reel-54, so it carries the tracked() non-breaking-space word-gap fix and the _payload quote fix; only SCENES differs, verified by diffing the two files with their SCENES blocks removed. Copy blend.py and encode.py in from reel-46; they are generic.",
      "Instagram caption 1,678 characters including hashtags (76.3% of the 2,200 limit, under the 2,090 warn line); TikTok 1,652 of 4,000. Both counts are what check_caption.py emits and both include the hashtag block, which is what actually gets pasted. Both plain text, both scanned clean of markdown, both measured in UTF-16 units by tools/check_caption.py, which exits 0.",
      "Curriculum position: lesson 55 is index 21 of content/lessons-3.json, the next unused lesson after 54. It covers 2026-09-29, the only bare date in the tomorrow-through-tomorrow+6 window this run. No growth/reach claims in either caption."
    ]
  },
  {
    id: 'reel-56',
    date: '2026-09-30',
    title: 'The Spirit rules are actual rules',
    type: 'Reel',
    pillar: 'Rules',
    difficulty: 'Beginner',
    lesson: 56,
    ...
    ig: `Spirit of the Game is not the soft bit at the front of the rulebook.
...
Follow @learn.ultimatefrisbee — one lesson a day.`,
    tiktok: `the spirit rules are actual rules 🥏
...
rules from WFDF Rules of Ultimate 2025–2028 (1.3, 1.3.1, 1.3.9, 1.3.10, 1.5.4, 1.4) — full breakdown in bio`,
    hashtags: ['#UltimateFrisbee', '#SpiritOfTheGame', '#WFDFRulesofUltimate', '#LearnUltimateFrisbee', '#UltimateFrisbeeTips'],
    notes: [
      "Nine scenes, three topic/rules pairs. TOTAL = 9. All six of the lesson's rules are carded and quoted in full in both captions; all six numbers are in the attribution line, in the array's own order.",
      "DRY-MEASURED 2026-09-23 in a scratch directory outside the repo, SVG only \u2014 no PNGs, no frames, no cut. check_layout.py: 9 scenes checked, 0 problems, exit 0; tallest is the cover at 1210 of the 1310 floor, the three main scenes at 1192. check_caption.py exits 0.",
      "Neither auto-fit engages. Kickers measured on the real label (#N + NBSP\u00d73 + tracked()): #1 540.4px of the 900px column (60.0%), #2 795.4px (88.4%), #3 765.3px (85.0%) \u2014 all inside reel-11's 873px high-water mark, all at the standard 34px. Bodies all wrap to four lines at 36px, last baseline 962, clearance 128px against the 1090 limit.",
      "Scene 4's body was drafted five lines (last baseline 1012, 78px clearance, still passing) and tightened to four while drafting, before anything went to the desk. The ban is on rewording an approved body to fit; nothing here is approved.",
      "All three cards carry two rule blocks each, deliberately: 1.3/1.3.1 is one sentence split by the rulebook's own numbering, 1.3.9/1.3.10 is a contrast, 1.4/1.5.4 is a principle and its instance. Scenes 5 and 7 are the tallest rules cards at 740 of the 1310 floor.",
      "1.3 ends on a colon, 1.3.1 is a sentence fragment and 1.5.4 ends '; and'. All three are quoted exactly as the rulebook has them, on the card and in both captions. Nothing is added to make them read as free-standing sentences \u2014 that would be paraphrase.",
      "1.3 is the stem of a list this post does not quote in full: items 1.3.2 through 1.3.8 exist and are not cited here. The lesson's rules array names six numbers and this post carries exactly those six; no card, caption or attribution line implies the list is complete.",
      "Projected duration 30.0s from retime()/fit() (37 states, band 28\u201333s). Durations in SCENES are untouched placeholders \u2014 do not hand-tune them.",
      "render_v3.py is committed in content/reel-56/ and is the exact file these numbers were measured from \u2014 copied from reel-55, so it carries the tracked() non-breaking-space word-gap fix and the _payload quote fix; only SCENES differs, verified by diffing the two files with their SCENES blocks removed. Copy blend.py and encode.py in from reel-46; they are generic.",
...
rule numbers from WFDF Rules of Ultimate 2025–2028 — full breakdown in bio`,
  ...
  },
  {
    id: 'reel-58',
    date: '2026-10-02',
    title: 'When several things go wrong at once',
    type: 'Reel',
    pillar: 'Rules',
    difficulty: 'Intermediate',
    lesson: 58,
    ...
    ig: `Two calls on the same play, and both of them stand. Now what?
...
Follow @learn.ultimatefrisbee — one lesson a day.`,
    tiktok: `when several things go wrong at once 🥏
