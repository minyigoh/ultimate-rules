...
rules from WFDF Rules of Ultimate 2025–2028 — full breakdown in bio`,
  ...
  },
  {
    ...
    difficulty: 'Beginner',
    lesson: 32,
    duration: '~30s script / v1 cut 29.5s (superseded)',
    typeDetail: '1080\u00d71920 \u00b7 29.5s \u00b7 30fps (v1 cut, built from script v2)',
    rules: ['15.1', '15.2', '17.6.1', '17.6.1.1', '17.6.1.2', '17.6.1.3', '18.1.1.2'],
    review: {
      script:  {status: 'pending', on: '2026-09-05'},
      content: {status: 'rerender', on: '2026-09-05'}
    },
    postedDate: null,
    folder: 'reel-32',
...
rules from WFDF Rules of Ultimate 2025–2028 — full breakdown in bio`,
    ...
    notes: [
      ...
      'NOT rebuilt this run. The cut in the folder is v1, built from script v2, and its scenes 4 and 5 no longer match the script. A redraft has to clear the script gate before it is rendered.',
