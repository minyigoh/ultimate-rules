...
rules from WFDF Rules of Ultimate 2025–2028 — full breakdown in bio`,
...

  {
    ...
    scenes: [
      ...
      ['2', '#1 THE DEFAULT: PLAY ON', '"Reset the pivot, take the paused count, carry on." · footer cites 18.2.5 · 18.2.5.1 · 18.2.5.2'],
      ['3', 'Rules detail', 'Verbatim 18.2.5 + 18.2.5.1 + 18.2.5.2'],
      ['4', '#2 STOPPER ONE: YOU THREW IT', '"Complete a pass before fixing the pivot and it comes back." · footer cites 18.2.6 · 18.2.7'],
      ['5', 'Rules detail', 'Verbatim 18.2.6 + 18.2.7'],
      ['6', '#3 STOPPER TWO: A CONTEST', '"Disagree with the disc still in hand and play halts." · footer cites 15.10 · 18.2.8'],
...
rules from WFDF Rules of Ultimate 2025–2028 — full breakdown in bio`,
    hashtags: ['#UltimateFrisbee', '#SpiritOfTheGame', '#WFDFRulesofUltimate', '#LearnUltimateFrisbee', '#UltimateFrisbeeTips'],
    notes: [
      'Rendered 2026-08-20 from the approved v2 script. Nine scenes, exact CFR via encode.py; 29.50s.',
      'Redrafted 2026-08-18 (v2) against the note that the reel taught the infraction half of travel and left the violation half as a footnote. v1 archived as script-and-caption.v1.md; round logged in script-feedback.md.',
      'Scene kickers were shortened at render time to fit the 900px text column: "THE DEFAULT: NOBODY FREEZES" to "THE DEFAULT: PLAY ON", "STOPPER ONE — YOU THREW IT ANYWAY" to "STOPPER ONE: YOU THREW IT", "STOPPER TWO — SOMEBODY CONTESTS" to "STOPPER TWO: A CONTEST". The script-table versions measured 1044-1156px tracked at 34px against a 900px column. Headlines, bodies and rule cards are unchanged.',
