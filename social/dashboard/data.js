...
rules from WFDF Rules of Ultimate 2025–2028 — full breakdown in bio`,
...

  {
    ...
    rules: ['12.3'],
    review: {
      script:  {status: 'pending', on: '2026-08-13'},
...
rules from WFDF Rules of Ultimate 2025–2028 — full breakdown in bio`,
    hashtags: ['#UltimateFrisbee', '#SpiritOfTheGame', '#WFDFRulesofUltimate', '#LearnUltimateFrisbee', '#UltimateFrisbeeTips'],
    notes: [
      'Drafted 2026-08-13 by the daily task. Awaiting script review.',
      'One-rule lesson: 12.3 is a single sentence and the lesson brief cites nothing else, so all three topic scenes foot to the same citation. Seven scenes projects to ~29s. Alternatives in the script notes — I did not add 12.1 on my own initiative.',
