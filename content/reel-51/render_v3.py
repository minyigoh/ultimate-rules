...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "Technical stoppages and blood", "Anyone can stop the game for a safety issue, and a bleeding wound has its own clock.", 51, size=84), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('call', g_main(2, 'ANYONE CAN CALL IT', "You don't need the disc to stop the game.", "If you see a condition that endangers players, call \"technical\" or \"stop\" and play halts at once. Team-mates and coaches should be speaking up as well.", ['19.2.1', '19.2.1.1'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('call_r', g_detail(3, [('19.2.1', [rt('19.2.1'), ('19.2.1.1', rt('19.2.1.1'))])]), [0.3, 2.0]),
    ('blood', g_main(4, 'BLOOD HAS A CLOCK', "An open wound gets seventy seconds.", "That is the window to cover it or clean it up. Need longer and it costs what an injury costs: come off, or charge your own team a time-out.", ['19.2.1.2'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('blood_r', g_detail(5, [('19.2.1.2', [rt('19.2.1.2')])]), [0.3, 2.0]),
    ('disc', g_main(6, 'A WRECKED DISC COUNTS', "The same call fixes broken kit.", "The thrower may stop play to replace a severely damaged disc. Same call, used for equipment rather than safety, and only the thrower makes it.", ['19.2.2'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('disc_r', g_detail(7, [('19.2.2', [rt('19.2.2')])]), [0.3, 2.0]),
    ('tip', g_tip(8, "This one call is not about advantage.", "Every other call in the book is about who gained what. This one is not, so nobody will think less of you for stopping a point over a cut hand or a dog on the pitch. Make it early and make it loud."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 51), [0.3, 0.8, 1.0, 1.4]),
]
