...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "Changing your mind is a rule, not a weakness", "There is a formal, written-down way to say \"actually, you're right\". It takes one word.", 24, size=76), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('say', g_main(2, 'SAY THE WORD', "Realise your call was wrong? Say \"Retracted\".", "Play then resumes as if an accepted breach had been caused by you, the player who made the call. So it is not free \u2014 you give something up to take it back.", ['15.11'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('say_r', g_detail(3, [('15.11', [rt('15.11')])]), [0.3, 2.0]),
    ('spirit', g_main(4, "IT'S ON THE LIST", "The rulebook names it as an example of good Spirit.", "Retracting a call you no longer believe in is not merely tolerated. It sits, by name, in the rulebook's own short list of examples of good Spirit.", ['1.5', '1.5.1'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('spirit_r', g_detail(5, [('1.5', [rt('1.5'), ('1.5.1', rt('1.5.1'))])]), [0.3, 2.0]),
    ('tip', g_tip(6, "\"Retracted, my bad\" takes two seconds and settles more than arguing does.", "In WFDF's own worked example, a marker who retracts a foul call against the thrower hands the stall count back to \u201cStalling 1\u201d. A small price, and always worth paying."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(7, 24), [0.3, 0.8, 1.0, 1.4]),
]
