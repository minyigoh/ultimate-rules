...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "Don't touch a pull you can't catch", "The most common free turnover in beginner ultimate happens before anybody has thrown a pass.", 46, size=84), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('touch', g_main(2, 'TOUCH IT, OWN IT', "Get a hand to the pull and you have accepted the consequences.", "If anyone on your team gets a hand to the pull before it hits the ground, and your team then fails to establish possession, that is a turnover. It does not matter whether you were in-bounds or out-of-bounds when you touched it. That speculative tip on a pull drifting out is a real risk.", ['7.8'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('touch_r', g_detail(3, [('7.8', [rt('7.8')])]), [0.3, 2.0]),
    ('turnover', g_main(4, 'IT IS A TURNOVER', "Not a technicality — it's on the rulebook's own turnover list.", "This is not a technicality tucked away in the pull chapter. The turnover chapter lists a dropped pull in its own right, alongside a drop, a throwaway and a block. Same list. Same consequence. It is not bad luck, it is a turnover you chose.", ['13.1', '13.1.4'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('turnover_r', g_detail(5, [('13.1', [rt('13.1'), ('13.1.4', rt('13.1.4'))])]), [0.3, 2.0]),
    ('leave', g_main(6, 'LET IT LAND', "Leave it alone and it costs you nothing at all.", "Now look at what leaving it alone costs you. Nothing. If the pull lands in the field and never goes out, you walk to wherever it stopped and establish your pivot there. Even if that is deep in your own end zone, the disc is still yours.", ['7.10'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('leave_r', g_detail(7, [('7.10', [rt('7.10')])]), [0.3, 2.0]),
    ('tip', g_tip(8, "If you're not certain you'll catch it cleanly, let it land. You lose nothing.", "So the maths is not close. Touching it can lose you possession and leaving it cannot. If you are not certain you will catch it cleanly, let it land. Nobody has ever been blamed for a pull they let bounce."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 46), [0.3, 0.8, 1.0, 1.4]),
]
