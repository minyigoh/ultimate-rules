...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', 'Where your feet have to be', "Ultimate has no \u201ctwo feet in\u201d rule. It has something simpler, and stricter.", 9, size=84), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('inout', g_main(2, 'NO TWO FEET IN', "If you're not out, you're in.", "There is no rule about getting two feet down. The rulebook defines it the other way round: an offensive player who is not out-of-bounds is in-bounds. One toe on the line and you were never in.", ['11.3'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('inout_r', g_detail(3, [('11.3', [rt('11.3')])]), [0.3, 2.0]),
    ('air', g_main(4, 'AIRBORNE', 'Your status waits for the landing.', 'Catch it in the air and nothing is settled yet. You keep whatever status you had until you touch down, and that first contact has to be in-bounds \u2014 the line itself is out.', ['11.3.1', '11.4'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('air_r', g_detail(5, [('11.3.1', [rt('11.3.1')]),
                          ('11.4', [rt('11.4'), ('11.4.1', rt('11.4.1')), ('11.4.2', rt('11.4.2'))])]), [0.3, 1.4, 2.0]),
    ('momentum', g_main(6, 'MOMENTUM IS FINE', 'Land in, then drift out.', "Once you have landed in-bounds and held the catch, running out over the sideline costs you nothing. Walk back and set your pivot where you crossed the line.", ['11.3.2'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('momentum_r', g_detail(7, [('11.3.2', [rt('11.3.2')])]), [0.3, 2.0]),
    ('tip', g_tip(8, 'Catch it before your foot lands', 'Sprinting for a disc near the sideline, timing beats stretching. Take it a stride early in the air rather than a stride late on the ground.'), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 9), [0.3, 0.8, 1.0, 1.4]),
]
