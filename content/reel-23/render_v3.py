...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "\"Contest\" \u2014 disagreeing properly", "Disagreement is built into the rules. There's a word for it, and there's machinery behind the word.", 23, size=76), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('say', g_main(2, 'SAY THE WORD', "If you don't think it happened, you say \"Contest\".", "The right to contest belongs to the player the call was made against. Say the word, play stops, and the two of you talk about it.", ['15.10'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('say_r', g_detail(3, [('15.10', [rt('15.10')])]), [0.3, 2.0]),
    ('back', g_main(4, 'NOBODY GAINS', "Can't agree? The disc goes back, and neither version wins.", "If, after discussion, players cannot agree \u2014 or it is unclear what happened \u2014 the disc returns to the last non-disputed thrower. Not the caller's version, not yours.", ['13.3'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('back_r', g_detail(5, [('13.3', [rt('13.3')])]), [0.3, 2.0]),
    ('brief', g_main(6, 'EXPLAIN, BRIEFLY', "Your whole job in the discussion is one clear sentence.", "Among the things players must do when they are acting as referees: explain their viewpoint clearly and briefly. Both halves of that are the rule.", ['1.3', '1.3.4'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('brief_r', g_detail(7, [('1.3', [rt('1.3'), ('1.3.4', rt('1.3.4'))])]), [0.3, 2.0]),
    ('tip', g_tip(8, "Have your one sentence ready before you open your mouth.", "Say what you saw, not what you concluded. A contest is not an accusation \u2014 it is the sport recording that two people saw the same two seconds differently."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 23), [0.3, 0.8, 1.0, 1.4]),
]
