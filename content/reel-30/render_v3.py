...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "Blocking fouls", "You got to the spot first, they ran into you, and you think that settles it. It doesn't \u2014 being there first is not the test.", 30, size=84), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('space', g_main(2, 'EMPTY SPACE IS YOURS TO TAKE', "Two conditions come attached.", "The permission comes first: any position on the field that no opponent is already occupying is yours to take. Two conditions ride along with it \u2014 you must not initiate contact taking it, and you must not be moving recklessly.", ['12.5'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
