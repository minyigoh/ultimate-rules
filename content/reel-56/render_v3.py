...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "The Spirit rules are actual rules", "Chapter 1 uses the word must, and it lists what you have to do.", 56, size=84), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('duty', g_main(2, 'THE WORD IS MUST', "Chapter 1 is not a preamble.", "Spirit of the Game is written as duties, not encouragement. Players act as their own referees, and the first duty listed is to know the rules and the spirit behind them.", ['1.3', '1.3.1'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('duty_r', g_detail(3, [('1.3', [rt('1.3')]), ('1.3.1', [rt('1.3.1')])]), [0.3, 1.7, 2.0]),
    ('consist', g_main(4, 'CALL IT THE SAME ALL GAME', "The score does not change the standard.", "Calls must be consistent from the first point to the last. A call is for a breach big enough to change the outcome, or where safety is at risk.", ['1.3.9', '1.3.10'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('consist_r', g_detail(5, [('1.3.9', [rt('1.3.9')]), ('1.3.10', [rt('1.3.10')])]), [0.3, 1.7, 2.0]),
    ('compete', g_main(6, 'COMPETITIVE IS NO EXCUSE', "Play hard. That is the whole point.", "Wanting to win is encouraged by the rulebook itself. What it will not trade away is mutual respect, the agreed rules, player safety and the basic joy of playing.", ['1.4', '1.5.4'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('compete_r', g_detail(7, [('1.4', [rt('1.4')]), ('1.5.4', [rt('1.5.4')])]), [0.3, 1.7, 2.0]),
    ('tip', g_tip(8, "Say your name before the point.", "Introducing yourself to your opponent is listed in the rules as good Spirit, and it is the cheapest thing on the list. Every call you make at that matchup afterwards is a conversation with someone you have met rather than an argument with a stranger."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 56), [0.3, 0.8, 1.0, 1.4]),
]
