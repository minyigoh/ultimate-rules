...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "Substitutions", "Unlimited between points, and almost none during one.", 52, size=84), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('window', g_main(2, 'UNLIMITED, THEN LOCKED', "Swap freely until you signal ready.", "After a goal you can change as many players as you like. The moment your team signals readiness for the pull, that line is set.", ['5.3'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('window_r', g_detail(3, [('5.3', [rt('5.3')])]), [0.3, 2.0]),
    ('match', g_main(4, 'THEY MAY MATCH IT', "An injury swap lets them swap too.", "If a player comes off after an injury, or for illegal or faulty equipment, the opposing team may also change one player. One for one, not a free reshuffle.", ['19.3'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('match_r', g_detail(5, [('19.3', [rt('19.3')])]), [0.3, 2.0]),
    ('state', g_main(6, 'A SUB INHERITS EVERYTHING', "They pick up exactly where you left off.", "Location, possession, stall count: the player coming on takes on the full state of the player going off, and may make a call on their behalf.", ['19.3.1'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('state_r', g_detail(7, [('19.3.1', [rt('19.3.1')])]), [0.3, 2.0]),
    ('tip', g_tip(8, "Signal ready only when your line is on.", "Raising a hand early is how teams end up playing a point a player short. Count the line on the field, then signal. After that the window is shut, and the only way back in is an injury or broken kit."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 52), [0.3, 0.8, 1.0, 1.4]),
]
