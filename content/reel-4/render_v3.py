...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', 'Five ways to lose the disc', "Know these five and you'll stop being surprised by sudden changes of possession.", 4), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('instant', g_main(2, 'INSTANT TURNOVERS', 'No whistle. It just flips.', 'Possession flips immediately, no stoppage, when the disc hits the ground, a defender catches it, or it goes out of bounds.', ['13.1'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('instant_r', g_detail(3, [('13.1', [rt('13.1'), ('13.1.1', rt('13.1.1')), ('13.1.2', rt('13.1.2'))])]), [0.3, 2.9]),
    ('stopped', g_main(4, 'STOPPED TURNOVERS', 'A few flip with a pause first.', 'Possession also flips, but with a stoppage, when the stall count reaches ten, or on odd acts like handing the disc to a teammate.', ['13.2'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('stopped_r', g_detail(5, [('13.2', [rt('13.2'), ('13.2.2', rt('13.2.2'))])]), [0.3, 2.6]),
    ('tip', g_tip(6, 'Sprint on the turn', 'The moment the disc hits the ground, sprint to guard someone. Points get lost in the two seconds right after a turnover.'), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(7, 4), [0.3, 0.8, 1.0, 1.4]),
]
