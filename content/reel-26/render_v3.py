...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "Who initiated the contact?", "Every foul argument is really one question: who got there first? The rulebook actually answers it.", 26, size=76), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('arrived', g_main(2, 'THEY WERE ALREADY THERE', "The initiator is usually just whoever arrived second.", "The rulebook defines the initiator rather than leaving it to argument. Limb one: you got to the point of contact after your opponent had already established a legitimate position there \u2014 and they count whether they were standing still or moving.", ['12.7', '12.7.1', '12.4'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('arrived_r', g_detail(3, [('12.7', [rt('12.7'), ('12.7.1', rt('12.7.1'))]), ('12.4', [rt('12.4')])]), [0.3, 1.7, 2.0]),
    ('changed', g_main(4, 'OR WHOEVER CHANGED PATH', "You can also initiate contact without arriving late at all.", "Limb two catches the other case. You were there in time, but you adjusted your line in a way that made contact unavoidable with someone moving legally \u2014 judged on every player's established position, speed and direction.", ['12.7', '12.7.2'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('changed_r', g_detail(5, [('12.7', [rt('12.7'), ('12.7.2', rt('12.7.2'))])]), [0.3, 2.0]),
    ('unclear', g_main(6, 'IF NOBODY CAN TELL', "Genuinely unclear, and someone laid out? It's theirs.", "When neither limb settles it, the rulebook supplies a tiebreaker. If one player dived, leaped or jumped away from their position, that player is deemed to have initiated the contact. Leaving the ground carries the risk.", ['12.7.3'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('unclear_r', g_detail(7, [('12.7.3', [rt('12.7.3')])]), [0.3, 2.0]),
    ('tip', g_tip(8, "Ask \"where were you when I got there?\"", "Notice what none of this asks about: intent. Nobody has to have meant it. The question is position, speed and direction \u2014 things two people can usually reconstruct together in about fifteen seconds."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 26), [0.3, 0.8, 1.0, 1.4]),
]
