...
SCENES = [
    ...
    ('defs', g_main(4, 'STILL A FOUL, DIFFERENT CALL', "\"Contact\" is not a different event.", "The rulebook defines a foul as non-minor contact, and an infraction as a marking or travel breach that does not stop play. The bump is a foul under the first definition. What the rule gives you is not a reclassification \u2014 it is the choice to handle that foul the way an infraction is handled, so the game keeps going.", ['15.1', '15.2'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('defs_r', g_detail(5, [('15.1', [rt('15.1')]), ('15.2', [rt('15.2')])]), [0.3, 1.7, 2.0]),
    ('choice', g_main(6, 'YOU CHOOSE IF PLAY STOPS', "Foul stops the game. \"Contact\" doesn't.", "If the contact lands before you release and not during your throwing motion, you have two calls. \"Foul\" stops play. \"Contact\" takes the infraction route \u2014 uncontested, play does not stop at all, and the marker must resume the stall count at one.", ['17.6.1.3'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
