...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', 'The pull: how every point starts', "It's ultimate's kickoff, and it has its own small ritual.", 7), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('throw', g_main(2, 'THE THROW', 'Defence throws it deep.', "Every point starts with the defence throwing the disc the length of the field to the offence — that's the pull.", ['7.1'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('throw_r', g_detail(3, [('7.1', [rt('7.1')])]), [0.3, 2.0]),
    ('ready', g_main(4, 'READY, THEN GO', 'A raised hand starts it.', 'Both teams signal ready with a raised hand before the pull goes. Nobody moves until the disc is actually released.', ['7.2', '7.6'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('ready_r', g_detail(5, [('7.2', [rt('7.2')]), ('7.6', [rt('7.6')])]), [0.3, 1.6, 1.8]),
    ('hold', g_main(6, 'STAY BEHIND THE LINE', "Feet planted till it's gone.", "Offence keeps a foot on their own goal line; defence stays fully behind theirs — both hold until the disc leaves the puller's hand.", ['7.3', '7.4'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('hold_r', g_detail(7, [('7.3', [rt('7.3')]), ('7.4', [rt('7.4')])]), [0.3, 1.6, 1.8]),
    ('tip', g_tip(8, 'Signal early and clearly', 'Raise your hand clearly and early. Half of all pull confusion is a team that never actually signalled.'), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 7), [0.3, 0.8, 1.0, 1.4]),
]
