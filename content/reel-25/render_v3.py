...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "The duty to avoid contact", "\"I was going for the disc\" is not a defence. The rulebook names that exact excuse and rejects it.", 25, size=76), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('nojust', g_main(2, 'NO JUSTIFICATION', "The rulebook does not leave you a situation where contact is fine.", "Every player must attempt to avoid initiating contact. That includes contact with an opponent standing still \u2014 and with where an opponent was obviously about to be, given the speed and direction they had already established.", ['12.6'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('nojust_r', g_detail(3, [('12.6', [rt('12.6')])]), [0.3, 2.0]),
    ('excuse', g_main(4, 'THE EXCUSE, NAMED', "\"I was going for the disc\" is written down, and rejected.", "Making a play for the disc is not a valid excuse for initiating contact. The rulebook names the reason players actually give, and closes it.", ['12.6.1'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('excuse_r', g_detail(5, [('12.6.1', [rt('12.6.1')])]), [0.3, 2.0]),
    ('ground', g_main(6, 'BEFORE YOU LEAVE THE GROUND', "Not sure you'll get there legally? Then you have to adjust.", "The duty lands before the bid. Be reasonably certain you won't initiate contact before you dive, leap or jump \u2014 and if you adjust to avoid it, the result of the play still stands.", ['12.6.2', '12.6.3'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('ground_r', g_detail(7, [('12.6.2', [rt('12.6.2')]), ('12.6.3', [rt('12.6.3')])]), [0.3, 1.7, 2.0]),
    ('tip', g_tip(8, "Bid hard, but into space you're sure is empty.", "This is what makes a non-contact sport playable at speed. Pulling out of a bid you weren't sure of costs you nothing \u2014 the rules say the result of the play still stands."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 25), [0.3, 0.8, 1.0, 1.4]),
]
