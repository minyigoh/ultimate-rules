...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "Dangerous play", "Every foul we've covered this week needed contact. This one doesn't. You can foul somebody you never touched.", 34, size=84), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('nocontact', g_main(2, 'NO CONTACT REQUIRED', "A dangerous bid is a foul even if it misses.", "Dangerous play is judged on the action, not on what it happened to hit. Reckless disregard for other players' safety, a significant risk of injury, or dangerously aggressive behaviour is a foul regardless of whether contact occurs, or when. The rule is not superseded by any other foul rule, and the remedy is the most relevant foul in the fouls section.", ['17.1.1'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('nocontact_r', g_detail(3, [('17.1.1', [rt('17.1.1')])]), [0.3, 2.0]),
    ('spirit', g_main(4, 'A SPIRIT VIOLATION TOO', "It's a Spirit violation too.", "Chapter one lists a handful of actions as clear violations of the Spirit of the Game that must be avoided. Dangerous play and aggressive behaviour is the first of them, alongside intentional fouling. It is not just a foul when it happens \u2014 it is behaviour you are asked to avoid.", ['1.6.1', '1.6.2'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('spirit_r', g_detail(5, [('1.6', [rt('1.6'), ('1.6.1', rt('1.6.1')), ('1.6.2', rt('1.6.2'))])]), [0.3, 2.0]),
    ('tip', g_tip(6, "If a play frightened you, say so at the time.", "\"That felt dangerous\" is a legitimate and important thing to raise, and it does not have to be an accusation. Say it while everyone still remembers the play. A bid nobody mentions is a bid that gets repeated."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(7, 34), [0.3, 0.8, 1.0, 1.4]),
]
