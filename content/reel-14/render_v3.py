...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "Slowing down after the catch", "You caught it at a sprint. The next two seconds are a rule.", 14, size=84), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('quick', g_main(2, 'AS QUICKLY AS POSSIBLE', "A sprint doesn't buy extra metres.", "After the catch you have to reduce speed as quickly as you reasonably can, until you have established a pivot point. Coasting on for a few more metres because you were moving fast is not part of the deal.", ['18.2.1'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('quick_r', g_detail(3, [('18.2.1', [rt('18.2.1')])]), [0.3, 2.0]),
    ('straight', g_main(4, 'AND IN A STRAIGHT LINE', 'You may slow down. You may not curve.', "That is the second half of the same sentence, and the half people break without noticing. Curling your deceleration towards a better throwing angle is changing direction, and it is not allowed.", ['18.2.1'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('travel', g_main(5, 'THE WRONG SPOT IS A TRAVEL', 'Where you stop is where the pivot goes.', "Get either half wrong and your pivot ends up somewhere it should not be. The rulebook names that case directly and lists it as a travel infraction rather than leaving it to interpretation.", ['18.2.4.1'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('travel_r', g_detail(6, [('18.2.4', [rt('18.2.4'), ('18.2.4.1', rt('18.2.4.1'))])]), [0.3, 2.0]),
    ('tip', g_tip(7, 'Decelerate in a straight line', "Drifting sideways as you slow is the travel most beginners commit without realising. Pick your stopping point before the disc arrives, then run to it."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(8, 14), [0.3, 0.8, 1.0, 1.4]),
]
