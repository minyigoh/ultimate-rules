...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "Caught it past the end zone? Walk it back.", "Not a turnover. Not a do-over. Just a short walk.", 13, size=76), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('keep', g_main(2, "IT ISN'T A TURNOVER", "You keep the disc. You just move it.", "You catch it in the central zone, your momentum carries you into the end zone you are attacking, and it is not a goal. Nothing has gone wrong. Play stays live and the disc is still yours.", ['14.3'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('keep_r', g_detail(3, [('14.3', [rt('14.3')])]), [0.3, 2.0]),
    ('spot', g_main(4, 'TO THE NEAREST POINT', "Not where you caught it. Not where you stopped.", "Walk to the closest point on the goal line and establish your pivot there. It does not matter how deep you ended up or where the catch happened \u2014 the nearest point on the line is the answer every time.", ['14.3'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('side', g_main(5, 'IT BEATS THE SIDELINE RULE', 'Out the back? Still the goal line.', "Normally you come back on wherever you crossed the perimeter line. Drift out over the back of the end zone you are attacking and 14.3 takes over instead: you go to the nearest point on the goal line.", ['11.3.2.1'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('side_r', g_detail(6, [('11.3.2.1', [rt('11.3.2.1')])]), [0.3, 2.0]),
    ('tip', g_tip(7, 'Walk out calmly and set your pivot', "None of this is a penalty, so there is nothing to panic about. Get to the line, plant the pivot, and take your first look from there rather than throwing on the move."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(8, 13), [0.3, 0.8, 1.0, 1.4]),
]
