...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "What actually counts as a goal", "Catching it in the end zone is necessary but not quite sufficient.", 12, size=84), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('cond', g_main(2, 'A GOAL HAS CONDITIONS', "Catching it in the end zone is only most of the way there.", "Three things have to be true at once: you are in-bounds, the pass was legal, and all of your ground contact is entirely inside the end zone you are attacking. Miss any one of them and it is just a catch.", ['14.1', '14.1.1'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('cond_r', g_detail(3, [('14.1', [rt('14.1'), ('14.1.1', rt('14.1.1'))])]), [0.3, 2.0]),
    ('feet', g_main(4, 'ALL OF YOU, NOT SOME OF YOU', 'One foot on the goal line is not a goal.', "Catch it airborne over the line and every one of your first points of ground contact has to land entirely inside the end zone. One foot in and one on the line does not score \u2014 the goal line belongs to the central zone, not to the end zone.", ['14.1.1'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('feet_r', g_detail(5, [('14.1.2', [rt('14.1.2')])]), [0.3, 2.0]),
    ('hold', g_main(6, 'YOU STILL HAVE TO CATCH IT', 'Bobbling it through the landing means no goal.', "The catch has to hold. You establish possession and keep it through all the ground contact related to that catch, exactly as you would anywhere else on the field \u2014 and the goal counts from the moment possession is established.", ['14.1.2', '14.4'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('hold_r', g_detail(7, [('14.4', [rt('14.4')])]), [0.3, 2.0]),
    ('tip', g_tip(8, "Don't celebrate until you've stopped moving", "The goal is scored at the moment you establish possession, not the moment the disc touches your hands. Land it, hold it, then celebrate."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 12), [0.3, 0.8, 1.0, 1.4]),
]
