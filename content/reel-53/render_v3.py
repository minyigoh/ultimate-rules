...
SCENES = [
    ...
    ('tip', g_tip(8, "Ask what the format is before you start.", "Most social and league games shorten this with a time cap or a lower target, so fifteen and eight are the default rather than a promise. Knowing the real target changes how you play a two-goal deficit late on."), [0.3, 0.45, 0.7, 1.7]),
