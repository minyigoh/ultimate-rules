...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "Injury stoppages", "What happens when someone goes down, and what it costs your team.", 50, size=84), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('call', g_main(2, 'ANYONE ON YOUR TEAM', "You don't have to be the one who is hurt.", "Any player on the injured player's team can call \"Injury\", and so can the player who is hurt. The stoppage counts from the moment of the injury, not the moment of the call.", ['19.1.1', '19.1.5'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('call_r', g_detail(3, [('19.1.1', [rt('19.1.1'), ('19.1.5', rt('19.1.5'))])]), [0.3, 2.0]),
    ('cost', g_main(4, 'IT COSTS YOU SOMETHING', "No opponent caused it? Sub, or a time-out.", "If an opponent did not cause it, the injured player must either be substituted or charge their own team a time-out. If an opponent did cause it, they may simply stay on.", ['19.1.2', '19.1.3'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('cost_r', g_detail(5, [('19.1.2', [rt('19.1.2'), ('19.1.3', rt('19.1.3'))])]), [0.3, 2.0]),
    ('disc', g_main(6, 'THE DISC IS STILL YOURS', "The injury made you drop it? You keep it.", "If you had established possession and the injury made you drop the disc, you keep it. If the disc was in the air when the call came, play carries on until it is caught or lands.", ['19.1.4', '19.1.6'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('disc_r', g_detail(7, [('19.1.4', [rt('19.1.4'), ('19.1.6', rt('19.1.6'))])]), [0.3, 2.0]),
    ('tip', g_tip(8, "Do not stop a disc in mid-flight.", "Calling it the instant somebody goes down and freezing everyone is the instinct, and it is the one thing this rule tells you not to do. If the disc is in the air, let the play finish. Then stop."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 50), [0.3, 0.8, 1.0, 1.4]),
]
