...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "Disc space: give the thrower room", "The most-called infraction in the sport, and the easiest one to never commit.", 17, size=80), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('diameter', g_main(2, 'ONE DISC DIAMETER', "About 27 cm. Roughly a forearm.", "No part of a defender may be closer than one disc diameter to the thrower's torso. Hold that much air between you and the person with the disc and you have essentially solved this rule for good.", ['18.1.1.3'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('diameter_r', g_detail(3, [('18.1.1', [rt('18.1.1'), ('18.1.1.3', rt('18.1.1.3'))])]), [0.3, 2.0]),
    ('torso', g_main(4, 'MEASURED TO THE TORSO', "You can reach. You can't crowd.", "The gap is measured to the torso, not to the disc and not to your hands. A mark that stretches an arm across the throwing lane is doing its job. Bringing your body in against theirs is not.", ['18.1.1.3'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('closed', g_main(5, 'UNLESS THEY CLOSED IT', "If the thrower moved into you, no infraction.", "The exception turns on one word: solely. It covers the standing marker who gets pivoted into. It does not cover drifting in and then blaming the pivot.", ['18.1.1.3'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('tip', g_tip(6, "Mark at a forearm's distance", "Set that gap before the count starts rather than adjusting after the call. The onus sits with the marker to hold the space, not with the thrower to defend it."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(7, 17), [0.3, 0.8, 1.0, 1.4]),
]
