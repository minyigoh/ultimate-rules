...
SCENES = [
    ('cover', g_cover(1, 'NEVER PLAYED BEFORE', 'The field, and why the lines are out', 'One detail here trips up almost every new player.', 6), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('layout', g_main(2, 'THE LAYOUT', '100m long. 37m wide.', 'Full field: 100 metres long, 37 metres wide, with an 18 metre end zone at each end.', ['2.1', '2.2'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('layout_r', g_detail(3, [('2.1', [rt('2.1')]), ('2.2', [rt('2.2')])]), [0.3, 1.6, 1.8]),
    ('lines', g_main(4, 'THE LINES ARE OUT', "Stand on one, you're out.", "The sidelines and end lines aren't part of the field. Toe one, and you're out of bounds — the opposite of most sports.", ['2.3', '11.1'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('lines_r', g_detail(5, [('2.3', [rt('2.3')]), ('11.1', [rt('11.1')])]), [0.3, 1.6, 1.8]),
    ('goalline', g_main(6, "THE GOAL LINE'S DIFFERENT", 'It belongs to the middle.', "The goal line is different — it belongs to the central zone, not the end zone. Catching with a foot on it isn't a goal.", ['2.4'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('goalline_r', g_detail(7, [('2.4', [rt('2.4')])]), [0.3, 2.0]),
    ('tip', g_tip(8, 'Look down near the line', 'When you catch near the sideline, look down. Toeing the line is out, not in — the opposite of most sports.'), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 6), [0.3, 0.8, 1.0, 1.4]),
]
