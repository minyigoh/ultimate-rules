...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "Force-out fouls", "You catch it a step inside the line, a defender bumps you, and your feet land out. Was that just out \u2014 or a foul that owes you something?", 31, size=84), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('moved', g_main(2, 'THE CONTACT MOVED YOU', "The foul has to be what put you there.", "A force-out foul is contact on a receiver who is in the process of establishing possession, before that possession is established, where the contact caused the catch to happen somewhere else. Two ways to be moved: across the sideline, or short of the end zone.", ['17.5.1', '17.5.1.1', '17.5.1.2'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('moved_r', g_detail(3, [('17.5.1', [rt('17.5.1'), ('17.5.1.1', rt('17.5.1.1')), ('17.5.1.2', rt('17.5.1.2'))])]), [0.3, 2.0]),
    ('goal', g_main(4, "IN THE END ZONE, IT'S A GOAL", "If it would have been a goal, it is a goal.", "The remedy gives back what the contact took. Where you would have caught the disc in your attacking end zone, the rule does not hand you the disc at the goal line to throw again. It gives you the point.", ['17.5.2'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('goal_r', g_detail(5, [('17.5.2', [rt('17.5.2')])]), [0.3, 2.0]),
    ('contested', g_main(6, 'CONTESTED SPLITS TWO WAYS', "Contested? It depends where you ended up.", "Most contested calls simply return the disc to the thrower. This one asks a second question first: if you became out-of-bounds, the disc goes back; if you stayed in, it stays with you.", ['17.5.3'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('contested_r', g_detail(7, [('17.5.3', [rt('17.5.3')])]), [0.3, 2.0]),
    ('tip', g_tip(8, "If you were going out anyway, it's just out.", "The word in the rule is caused. Contact near a line is not the test \u2014 contact that changed which side of the line you finished on is. If your momentum was taking you out regardless, the bump did not move you, and there is nothing to call."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 31), [0.3, 0.8, 1.0, 1.4]),
]
