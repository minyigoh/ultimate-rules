...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "Helping beginners is written into the rules", "If you are new, the rulebook is on your side.", 57, size=84), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('assist', g_main(2, 'EXPLAIN, DO NOT EXPLOIT', "A novice breach is a teaching moment.", "If a new player breaches a rule they clearly do not know, experienced players are told to explain it. That instruction is in the rules, not in an etiquette guide.", ['1.8'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('assist_r', g_detail(3, [('1.8', [rt('1.8')])]), [0.3, 2.0]),
    ('supervise', g_main(4, 'YOU MAY SUPERVISE', "Guiding a beginners' game is allowed.", "An experienced player may supervise a game involving beginners or younger players, offering advice on the rules and guiding the arbitration that happens on the field.", ['1.9'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('supervise_r', g_detail(5, [('1.9', [rt('1.9')])]), [0.3, 2.0]),
    ('team', g_main(6, 'LEARNING IS A TEAM JOB', "Two of the duties belong to the team.", "The rulebook gives teams their own list of duties. Two are about learning: teach your own players the rules and good Spirit, and tell other teams how they could improve.", ['1.7.1', '1.7.3'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('team_r', g_detail(7, [('1.7.1', [rt('1.7.1')]), ('1.7.3', [rt('1.7.3')])]), [0.3, 1.7, 2.0]),
    ('tip', g_tip(8, "Say you are new.", "If you do not know a rule, ask the person who called it to explain it. It is a completely normal thing to say on an ultimate field, and the rules tell the person you are asking to give you a straight answer."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 57), [0.3, 0.8, 1.0, 1.4]),
]
