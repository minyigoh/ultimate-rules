...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "You have to fetch the disc promptly", "There is a time limit on picking the disc up after a turnover. Two of them, actually, and almost nobody knows either.", 44, size=84), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('duty', g_main(2, 'WALKING PACE OR FASTER', "Both teams have a duty here, not just the one chasing the disc.", "After a turnover or a pull, you cannot stroll. The rule says walking pace or faster, directly to the disc, and directly to the pivot spot. It is not one-sided though. The defence is not allowed to get in your way while you do it, and if they are standing between you and the disc, say so.", ['8.5', '8.5.3'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('duty_r', g_detail(3, [('8.5', [rt('8.5')]), ('8.5.3', [rt('8.5.3')])]), [0.3, 1.7, 2.0]),
    ('numbers', g_main(4, 'TEN SECONDS, OR TWENTY', "There are actual numbers, and almost nobody knows them.", "There are hard numbers behind that, and almost nobody knows them. Ten seconds to set your pivot if the disc came to rest in the central zone. Twenty if it came to rest in an end zone. The clock starts when the disc stops, not when you get to it.", ['8.5.1.1', '8.5.1.2'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('numbers_r', g_detail(5, [('8.5.1', [rt('8.5.1'), ('8.5.1.1', rt('8.5.1.1')), ('8.5.1.2', rt('8.5.1.2'))])]), [0.3, 2.0]),
    ('warning', g_main(6, 'A WARNING FIRST', "You get told before anything happens to you.", "Nothing happens to you without warning. The defence calls Delay of Game, or starts a pre-stall, or calls a violation. But keep dawdling after that warning and the marker may simply start the stall count — on a disc you are not holding yet, from wherever they are standing.", ['8.5.2', '8.5.2.1'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('warning_r', g_detail(7, [('8.5.2', [rt('8.5.2')]), ('8.5.2.1', [rt('8.5.2.1')])]), [0.3, 1.7, 2.0]),
    ('tip', g_tip(8, "Jog to the disc as a habit. It costs nothing and removes the whole conversation.", "Jog to the disc. Not a sprint, just not a stroll. It costs you nothing, it removes the entire conversation, and it is the single easiest way to look like you have played before."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 44), [0.3, 0.8, 1.0, 1.4]),
]
