...
SCENES = [
    ('cover', g_cover(1, 'BEGINNER', "Live play and dead play", "There are moments in a point where you literally cannot turn the disc over. Knowing which ones tells you when you can relax.", 45, size=84), [0.35, 0.55, 0.85, 1.05, 0.6]),
    ('before', g_main(2, 'DEAD BEFORE THE PULL', "Two windows where nothing can be turned over.", "Dead play means no turnover is possible. Nothing you do can lose you the disc. There are four windows and the first two happen before anything has gone wrong: from the start of a point until the pull is released, and while the disc is being carried to the pivot spot after a pull or a turnover.", ['8.1', '8.1.1', '8.1.2'], 1), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('before_r', g_detail(3, [('8.1', [rt('8.1'), ('8.1.1', rt('8.1.1')), ('8.1.2', rt('8.1.2'))])]), [0.3, 2.0]),
    ('after', g_main(4, 'DEAD AFTER A CALL', "And two more, both of them after something has gone wrong.", "The other two happen after something has. After any call or stoppage, play is dead until the disc is checked in. And after the disc hits the ground, it is dead until somebody actually establishes possession. That last one is why a bobbled pick-up is not a turnover.", ['8.1', '8.1.3', '8.1.4'], 2), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('after_r', g_detail(5, [('8.1', [rt('8.1'), ('8.1.3', rt('8.1.3')), ('8.1.4', rt('8.1.4'))])]), [0.3, 2.0]),
    ('live', g_main(6, 'LIVE, AND ONE LIMIT', "Everything else is live — and you still cannot hand it over.", "Everything else is live, and live is where you can lose it. Players are free to move during dead play unless a rule says otherwise, so it is not a freeze — with one restriction that surprises people. The thrower may not hand the disc to a team-mate during dead play. Whoever has it, throws it.", ['8.2', '8.3'], 3), [0.3, 0.45, 0.7, 1.5, 0.8]),
    ('live_r', g_detail(7, [('8.2', [rt('8.2')]), ('8.3', [rt('8.3')])]), [0.3, 1.7, 2.0]),
    ('tip', g_tip(8, "Dead play is your thinking time. Use the walk to pick your first throw.", "Dead play is your thinking time and most beginners waste it. The walk to the pivot is the only unhurried moment you get all point. Use it to look downfield and pick your first throw, so you are not deciding under a stall count."), [0.3, 0.45, 0.7, 1.7]),
    ('close', g_closing(9, 45), [0.3, 0.8, 1.0, 1.4]),
]
